...
class AttnProcessor:
    ...
    def __call__(
        ...
        cross_attn_save_hidden_states=False,
    ):
        """
        ...
        if cross_attn and cross_attn_save_hidden_states:
        ...
        if (not cross_attn) or (
            ...
            with torch.backends.cuda.sdp_kernel(
                enable_flash=enable_flash_attn,
                enable_math=True,
                enable_mem_efficient=enable_flash_attn,
            ):
                return self.__call_fast__(
