...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if use_gated_attention:
            self.position_net = PositionNet(
                positive_len=768, out_dim=cross_attention_dim[-1]
            )
    ...
    def forward(
        ...
        if (
            ...
            cross_attention_kwargs["gligen"] = {
                "objs": self.position_net(
                    ...
                    positive_embeddings=cross_attention_kwargs["gligen"][
                        "positive_embeddings"
                    ],
                ),
                "fuser_attn_kwargs": cross_attention_kwargs["gligen"].get(
                    "fuser_attn_kwargs", {}
                ),
            }
        ...
        return UNet2DConditionOutput(
            sample=sample,
            cross_attention_probs_down=cross_attention_probs_down,
            cross_attention_probs_mid=cross_attention_probs_mid,
            cross_attention_probs_up=cross_attention_probs_up,
        )
